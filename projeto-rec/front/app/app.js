...
.controller('MainCtrl', function ($scope, $http) {
    ...
    $scope.result = [];
    var fullMovieList = [];
    $http.get("http://localhost:9091/api/movies").then(function (resp) {
    ...
    $scope.getRecommendations = function () {
        $http.post("http://localhost:9091/api/recommendation", {movie_ids: $scope.watchedMovies}, { headers: {'Content-Type': 'application/json; charset=UTF-8' }}).then(function (value) {
